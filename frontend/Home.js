	...
	render() {
		return (
			<div className="footer">
				<Button disabled={!this.state.canEdit} className="prevButton" onClick={this.props.onNextClick}> Edit </Button>
				<Button
						disabled={!this.props.validState || this.props.publishing || !this.state.canEdit}
